      ...
      <div class="container">
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-5 px-lg-4">
            <h1 class="text-base text-primary text-uppercase mb-4">Menjadi Programmer</h1>
                ...
                if($_SERVER['REQUEST_METHOD']=='POST'){
                    ...
                    if($username=='' || $password==''){
                        echo "<div class='alert alert-warning  show alert-dismissible mt-2'>
                                silakan masukkan username dan password dengan benar !
                            </div>";	
                    }else{
        ...
        <p class="mt-5 mb-0 text-gray-400 text-center">Design by <a href="https://bootstrapious.com/admin-templates" class="external text-gray-400">Bootstrapious</a> & magung</p>
